    ...
    <section className="my-8 container mx-auto px-2 md:px-0">
      ...
      <div className="bg-img rounded-3xl text-white py-4 px-2 md:px-6 drop-shadow-2xl mb-8">
        <div className="flex flex-col items-center md:items-start justify-center w-full gap-3">
          <h2 className="text-2xl font-bold md:mb-2 flex items-center justify-start gap-2 tracking-wider">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-8">
              <path strokeLinecap="round" strokeLinejoin="round" d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
            </svg> Hey <span className='font-lowballBold flex items-center'>{user.channelName} !</span>
          </h2>
          <div className="flex items-center justify-center gap-3 flex-wrap">
            ...
            <Link to={'/youtuber/all-editors'} className="brandBtnOutline w-full md:w-auto text-white hover:text-gray-200 px-5 py-2 rounded flex items-center justify-center gap-2 text-lg">
              ...
              </svg> View All Editors
            </Link>
          </div>
        </div>
      </div>

      <div className="bg-img rounded-3xl text-white py-4 px-6 drop-shadow-2xl min-h-[25vh]">
