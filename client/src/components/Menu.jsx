...
const Menu = () => {
    ...
    return (
        <div className="w-full flex flex-col lg:flex-row gap-3 md:gap-3 lg:justify-end">
            ...
            {user && <button onClick={handleLogout} className={`cursor-pointer text-white text-2xl font-lowballLight tracking-wider hover:bg-[#27272a] transition-all duration-200 ease-out py-2 px-4 rounded-lg flex items-center justify-start gap-5 lg:gap-2 ${isActive('/account/logout')
            ...
            <Link className={`cursor-pointer text-white text-2xl font-lowballLight tracking-wider hover:bg-[#27272a] transition-all duration-200 ease-out py-2 px-4 rounded-lg flex items-center justify-start gap-5 lg:gap-2 ${isActive('/us/contact-us')
                ? 'bg-[#27272a] hover:bg-none' : ''}`} to={'/us/contact-us'}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
