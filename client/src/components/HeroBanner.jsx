    ...
    return (
        <div className="flex flex-col items-center justify-center md:gap-5">
            ...
            <div className="flex items-center justify-between gap-3">
                <button type="button" onClick={handleChannelRedirect} className="btn brandBtn text-white py-2 px-6 rounded-lg text-xl tracking-wider flex items-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M5.25 5.653c0-.856.917-1.398 1.667-.986l11.54 6.347a1.125 1.125 0 0 1 0 1.972l-11.54 6.347a1.125 1.125 0 0 1-1.667-.986V5.653Z" />
                </svg> YouTuber</button>
                <button type="button" onClick={handleEditorRedirect} className="btn brandBtnOutline text-white py-2 px-6 rounded-lg text-xl tracking-wider flex items-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
