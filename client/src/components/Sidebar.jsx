...
import YouLayerPngSvg from '/images/YouLayerPngSvg.png'
        ...
        <aside className={`fixed left-0 top-0 z-10 h-[100vh] w-full overflow-hidden transition-all duration-300 lg:hidden ${isOpen ? "pointer-events-all opacity-100" : "pointer-events-none opacity-0 lg:opacity-100 lg:pointer-events-auto"}`}>
            ...
            <div className={`relative mr-auto transition-transform duration-300 ease-in-out flex flex-col max-w-[285px] px-2 py-4 h-[100vh] gap-4 bg-custom-gradient justify-between ${isOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"}`} ref={modalRef}>
                ...
                <div className="border-t border-[#222] py-10">
                    ...
                    <Link to={'https://x.com/1omsharma'} className='rounded-full p-2 bg-[#1d1d1d] w-12 h-12 text-center color-[#cfcfcf] iconhoverActive md:iconhover flex justify-center items-center'>
                        ...
                        <Link to={'https://github.com/coderomm'} className='rounded-full p-2 bg-[#1d1d1d] w-12 h-12 text-center color-[#cfcfcf] iconhoverActive md:iconhover flex justify-center items-center'>
                        ...
                        <Link to={'https://www.linkedin.com/in/1omsharma/'} className='rounded-full p-2 bg-[#1d1d1d] w-12 h-12 text-center color-[#cfcfcf] iconhoverActive md:iconhover flex justify-center items-center'>
                        ...
                        <Link to={'https://www.instagram.com/coder.om'} className='rounded-full p-2 bg-[#1d1d1d] w-12 h-12 text-center color-[#cfcfcf] iconhoverActive md:iconhover flex justify-center items-center'>
                            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 30 30" className='fill-white w-6'>
