...
const Header = () => {
    ...
    return (
        ...
        transition-all duration-400 z-[1] rounded-b-[35px] backdrop-blur-[10px] max-w-full p-[20px_40px]">
            ...
            <div className="flex gap-2 justify-end sm:flex-grow">
                ...
                <button className="block lg:hidden text-white" onClick={() => setSideBarOpen((prev) => !prev)}>
