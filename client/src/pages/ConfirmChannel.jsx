        ...
        <section className="my-8 container mx-auto px-2 md:px-0">
            ...
            <div className="bg-img rounded-3xl text-white py-4 px-2 md:px-6 drop-shadow-2xl mb-8">
                <div className="p-16 flex items-center justify-center flex-col text-center rounded-lg drop-shadow-2xl">
                    ...
                    {status === 'success' && <p className="cursor-pointer underline font-semibold text-center flex items-center justify-center gap-2 text-3xl">{message} <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                    ...
                    {status === 'error' && <p className="cursor-pointer underline font-semibold text-center flex items-center justify-center gap-2 text-3xl"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
