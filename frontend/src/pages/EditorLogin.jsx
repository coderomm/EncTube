  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center my-8 container mx-auto px-4 md:px-0">
      <div className="bg-white p-8 rounded-lg drop-shadow-2xl w-full md:w-2/3 lg:w-[35%]">
        <h2 className="text-2xl font-bold mb-8 text-center">Login in to your account</h2>
        <form onSubmit={handleLogin}>
          ...
          <div className="flex items-center flex-wrap mt-3">
            <Link to={'/editor/signup'} className='flex-1 my-3 underline font-semibold text-indigo-600 hover:text-indigo-500 text-center mx-auto block'>Don&apos;t have an account?</Link>
            <Link to={'/editor/forgot-password'} className='flex-1 my-3 underline font-semibold text-indigo-600 hover:text-indigo-500 text-center mx-auto block'>Forgot Password?</Link>
          </div>
        </form>
      </div>
    </div>
