            ...
            <div className="container mx-auto p-4 px-2">
                {channel && (
                    <div className=" text-white py-4 drop-shadow-2xl mb-4 sm:flex items-center justify-start">
                        ...
                        </svg>Selected Channel - <nbsp></nbsp>
                        </h2>
                        <h3 className='text-xl font-bold'> {channel.youtuber.channelName} | <span className='text-xl text-[#999]'>{channel.youtuber.channelUrl}</span></h3>
                    </div>
                )}
                <hr className="border-white border-1 mb-4"></hr>
                <div className="mb-4 grid grid-cols-1 gap-4">
                    <div className=" text-white py-4 rounded-lg drop-shadow-2xl">
                        <h2 className="text-2xl font-bold mb-1 flex items-center justify-start gap-2"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                    ...
                    <hr className="border-white border-1 mb-4"></hr>
                    <div className="text-white rounded-lg drop-shadow-2xl">
                        <form onSubmit={handleUpload}>
                            <h2 className="text-2xl font-bold mb-1">🎬 Add/Upload New Video</h2>
