    ...
    return (
        <>
            <section className="mx-1 mt-2 md:mx-10 md:mt-4 p-8 px-2 md:p-16 md:py-7 text-center">
                <h1 className="text-4xl md:text-6xl text-white font-lowballBold tracking-wider">About EncTube</h1>
                <h3 className="text-3xl md:text-3xl text-white font-lowballThin tracking-wider mt-3">🎬 EncTube: Edit with Control, Publish with Confidence! 🚀</h3>
                <div className="text-center text-[#e2e2e2] text-xl tracking-wide mt-2">
                    <p>Empower your YouTube channel with seamless collaboration while keeping your sensitive data under wraps. With EncTube, editors can create and upload content without ever touching your private metrics, letting you review, tweak, and publish videos effortlessly.</p>
                </div>
            </section>
            <section className="mx-1 mt-2 md:mx-10 md:mt-4 p-8 px-2 md:p-16 md:py-7 text-center">
