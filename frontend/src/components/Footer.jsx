...
export const Footer = () => {
    return (
        <div className="flex flex-col md:flex-row gap-16 justify-evenly items-start">
            <div className="flex flex-col justify-start gap-3">
                ...
                <p className="font-extralight text-lg tracking-wider text-[#999999]">Connected with us!</p>
                <div className="flex gap-3 items-center justify-center">
                    <Link className='rounded-full p-2 bg-[#1d1d1d] w-12 h-12 text-center color-[#cfcfcf] iconhover flex justify-center items-center'>
            ...
            <div className="flex flex-col justify-start gap-1">
                <h3 className="text-2xl font-semibold tracking-wider">BROWSE</h3>
            ...
            <div className="flex flex-col-reverse justify-start md:justify-between py-6 border-t border-[#1e1d1d] gap-3">
                <p className="font-extralight text-lg tracking-wider text-[#999999]">© EncTube 2024, Designed CoderOm</p>
                <a href="" className="font-extralight text-lg tracking-wider text-[#999999]">Privacy Policy</a>
            </div>
        </div>
    )
}