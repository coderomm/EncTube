        ...
        <div className="bg-img min-h-80 container mx-auto my-8 px-4 md:px-0 flex items-center justify-center">
            <div className="text-white p-4 rounded-lg drop-shadow-2xl">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <button type="submit" className={`brandBtn font-bold drop-shadow-2xl text-white w-full py-2 rounded-lg flex items-center justify-center gap-2 ${loading ? 'opacity-50 cursor-not-allowed' : ''}`} disabled={loading}>
