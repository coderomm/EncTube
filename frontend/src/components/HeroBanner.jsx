...
const HeroBanner = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center md:gap-5">
            ...
            <button type="button" onClick={handleYoutuberLogin} className="flex items-center justify-between gap-3 mt-3  bg-[#27272a] py-2 px-4 rounded-full text-white tracking-wider text-xl">
